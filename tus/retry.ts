import type { R2Bucket, R2UploadedPart, R2MultipartUpload } from '@cloudflare/workers-types'
...
export class RetryBucket {
  ...
  async put(
    ...
    return retry(
      // @ts-expect-error: Blob is not assignable to string | ArrayBuffer | ArrayBufferView
